    ...
    fetch("/assets/products/products.json")
      ...
      .then((products) => {
        ...
        if (product) {
          ...
          const voltage = product.technical_specs.voltage
            ? product.technical_specs.voltage
            : "N/A";
          const maxTemp = product.technical_specs.max_temp
            ? product.technical_specs.max_temp
            : "N/A";
          ...
          document.getElementById("email-order").addEventListener("click", () => {
            ...
            window.location.href = `mailto:khilary4600@gmail.com?subject=${encodeURIComponent(
              emailSubject
        ...
        if (similarProducts.length) {
          ...
          similarProducts.forEach((similarProduct) => {
            ...
            similarProductElement.innerHTML = `
                ...
                <img src="${similarProduct.image}" alt="${similarProduct.name}" onerror="this.src='/assets/img/skyjet-placeholder.png'">
                <p>${
                  similarProduct.description
                    ? similarProduct.description
                    : "No description available"
                }</p>
                <a href="product-details.html?sku=${
                  similarProduct.sku
