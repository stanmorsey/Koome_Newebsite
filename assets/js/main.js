...
function loadProducts() {
  fetch('assets/products/products.json')
    ...
    .then(data => {
      // Store products in a variable after fetching
      products = data;
    })
    .catch(error => {
...
// Call this function to load the products when the page loads
loadProducts();
...
function searchProducts() {
  ...
  // Filter products based on input matching SKU, name, or category
